...
export function DomainConfiguration({ domain }: { domain: string }) {
  ...
  return (
    <div className="border-foreground/20 border-t pb-5 pt-7">
      <div className="mb-4 flex items-center space-x-2">
        <p className="text-foreground text-lg font-semibold">{status}</p>
      ...
      {txtVerification ? (
        <>
          ...
          <div className="bg-foreground/20 text-foreground my-5 flex items-start justify-start space-x-10 rounded-md p-2">
            <div>
        ...
        <p className="text-foreground mb-5 text-sm">
        ...
        <>
          ...
          <div className="my-3 text-left">
            <p className="text-foreground my-5 text-sm">
              To configure your{' '}
            ...
            <div className="bg-foreground/5 text-foreground flex items-center justify-start space-x-10 rounded-md p-2">
              <div>
                <p className="text-sm font-bold">Type</p>
