    ...
    <>
      ...
      <Drawer.Root open={visible} onOpenChange={setVisible}>
        <Drawer.Portal>
          ...
          <Drawer.Content className="bg-background fixed bottom-0 left-0 right-0 mt-24 flex h-fit max-h-[90vh] min-h-[90vh] flex-col rounded-t-[10px] px-0 pb-0 outline-none text-foreground">
            <div
              aria-hidden
