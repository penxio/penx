  ...
  return (
    <>
      ...
      <div className="relative flex-1">
        <div className="absolute bottom-0 left-0 right-0 top-0 flex h-full flex-1 flex-col overflow-auto px-6">
          <div className="relative z-50 flex flex-1 flex-col pt-6">
            ...
            {!isMobileApp && (
              <div className="sticky bottom-0 pb-6">
                <div className="mx-auto flex w-full max-w-xl flex-col items-center justify-center gap-2">
                  <JournalQuickInput />
                </div>
              </div>
            )}
