...
function Sidebar({
  ...
  return (
    <div
      className={cn(
        'text-sidebar-foreground group peer',
    ...
    >
      ...
      <div
        ...
        className={cn(
          'w-(--sidebar-width) fixed inset-y-0 z-10 h-svh transition-[left,right,width] duration-200 ease-linear',
  ...
  return (
    <main
      ...
      className={cn(
        ...
        !isDesktop && 'md:peer-data-[variant=inset]:m-2',
        isDesktop && 'm-2',
        className,
      )}
      {...props}
...
function SidebarContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex min-h-0 flex-1 flex-col gap-0 overflow-auto px-2 group-data-[collapsible=icon]:overflow-hidden',
        className,
      )}
      {...props}
    />
