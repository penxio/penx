...
import { CopilotPlugin } from '@penx/editor-custom-plugins'
import { Button } from '@penx/editor-plugins/plate-ui/button'
import {
  Command,
  CommandEmpty,
  CommandGroup,
  ...
  CommandItem,
  CommandList,
} from '@penx/editor-plugins/plate-ui/command'
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger,
} from '@penx/editor-plugins/plate-ui/dialog'
import { Input } from '@penx/editor-plugins/plate-ui/input'
import {
  Popover,
  PopoverContent,
  PopoverTrigger,
} from '@penx/editor-plugins/plate-ui/popover'
